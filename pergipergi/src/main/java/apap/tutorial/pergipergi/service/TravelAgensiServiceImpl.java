...
public class TravelAgensiServiceImpl implements TravelAgensiService {
    ...
    @Override
    public void addAgensi(TravelAgensiModel travelAgensi) {travelAgensiDb.save(travelAgensi);}

    @Override
    public List<TravelAgensiModel> getListAgensi() { return travelAgensiDb.findAll();}
    ...
    @Override
    public List<TravelAgensiModel> getListAgensiOrderedAsc() { return travelAgensiDb.findByOrderByNamaAgensiAsc();}
